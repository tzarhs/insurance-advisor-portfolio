...
export default function Navbar() {
  ...
  return (
    <nav className="absolute top-0 left-0 right-0 z-50 px-6 md:px-16">
      <div className="max-w-6xl mx-auto flex items-center justify-between h-[70px]">
        ...
        <button
          ...
          className="text-white text-sm tracking-[0.1em] uppercase px-5 py-2.5 rounded-sm transition-opacity duration-200 hover:opacity-85"
